 ...
 */
package cursoemvideo.olaterra;

/**
 *
 * @author Daniel
 */
public class OlaTerraJava extends javax.swing.JFrame {

    /**
     * Creates new form OlaTerraJava
     */
    public OlaTerraJava() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btmClick.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btmClick.setText("Clique");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OlaTerraJava.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OlaTerraJava().setVisible(true);
            }
        });
    }
